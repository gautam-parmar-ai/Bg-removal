...
const Header = () => {
  ...
  return (
    <div className="flex items-center justify-center max-sm:flex-col-reverse gap-y-10 gap-x-20 px-4 mt-10 lg:px-44 sm:mt-20">
      {/* ------Left Side-------- */}
      <div>
        ...
        <p className="my-6 text-[15px] text-gray-500">
          ...
          <br className="max-md:hidden" />
          iure! Velit vero tenetur similique optio harum ullam dicta officiis!
        </p>
        <div>
          <input
